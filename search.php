<?php 
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $user_vids = "";
        $stmt = mysqli_prepare($db, "SELECT media.MediaID, Title, Description, Pathway, DateAdded, Category, numViews, PublisherID, Type FROM Media 
                                JOIN keywords ON media.MediaID=keywords.MediaID WHERE keyword LIKE ?") or die("Error");
